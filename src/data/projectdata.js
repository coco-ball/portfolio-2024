const getImageArray = (name, imgNum) => {
    const imageArray = [];
...
const projectData = [
    {
        ...
        year: "2022-2023",
        link: "",
        engDescription: "Mindly is an Emotional-responsive Meditation Metaverse Based on Computer Vision AI Model. Under two professors, we conducted the research with six team members, wrote a thesis, and presented it at the HCI Conference. We built a brand identity and produced service guide banners and brochures.",
        korDescription: "Mindly는 컴퓨터비전 AI모델을 활용한 감정반응형 명상공간 메타버스입니다. 교수님 2분의 지도 아래 팀원 6인과 해당 연구를 진행, 논문을 작성하여 HCI 학회에서 발표하였습니다. 브랜드 아이덴티티를 구축하고 서비스 가이드 배너 및 브로셔를 제작하였습니다.",
    ...
    },
    {
        ...
        year: "2023",
        link: "",
        engDescription: "This project re-established the brand identity of S-Factory, a complex cultural space in Seongsu. S-Factory has operated four buildings, A, B, C, and D, as the centers of culture, art, and communication, connecting Seongsu, brands, and people. Based on this brand identity, we developed a new design system, including a logo that shows the linear flow and a versatile modules.",
        korDescription: "성수동의 복합문화공간 에스팩토리(S-Factory)의 브랜드 아이덴티티를 재정립하였습니다.에스팩토리는 A,B,C,D 네 개의 동을 문화, 예술, 소통의 창으로 운영하며 성수, 브랜드, 그리고 사람들을 연결합니다. 이에 착안하여 선적인 흐름이 나타나는 로고와 조합이 자유로운 모듈 등 새로운 디자인 시스템을 개발하였습니다.",
    ...
    },
    {
        ...
        year: "2023",
        link: "",
        engDescription: 'Perfume is the opening sequence of the movie "Perfume: The Story of a Murderer". To depict the process of creating a perfume abstractly, most scenes were shot by myself, and the complementary shades were used to create a bizarre atmosphere.',
        korDescription: "Perfume은 영화 “향수 : 어느 살인자의 이야기”의 오프닝 시퀀스입니다. 향수를 만드는 과정을 추상적으로 묘사하기 위해 직접 촬영하였으며 보색을 활용한 색감으로 기이한 분위기를 연출하였습니다.",
    ...
    },
    {
        ...
        year: "2023",
        link: "",
        engDescription: "A typography poster inspired by Shinichi Kobayashi's guitar manual <Hell's Mechanical Guitar Training>.",
        korDescription: "코바야시 신이치의 기타 교본 <지옥의 메커니컬 기타 트레이닝>을 주제로 작업한 타이포그래피 포스터입니다.",
    ...
    },
    {
        ...
        year: "2023",
        link: "",
        engDescription: "The Physiological Process of Tattooing is an animated explainer video which visualizes what happens to our body when we get a tattoo.",
        korDescription: "The Physiological Process of Tattooing은 타투를 받을 때 몸에서 일어나는 일과 원리를 설명한 애니메이션입니다.",
    ...
    },
    {
        ...
        year: "2023",
        link: "",
        engDescription: "BooYoo is a video visualizing the word 浮遊. A calm pond was designed by overlapping wave layers mixed with blend mode and floating several pieces of duckweed on top.",
        korDescription: "BooYoo는 단어 浮遊(부유)를 시각화한 비디오입니다. 블렌드 모드를 입힌 물결을 여러 겹 쌓고, 몇 점의 개구리밥을 올려 잔잔한 연못을 만들어냈습니다.",
    ...
    },
    {
        ...
        year: "2023",
        link: "",
        engDescription: "This is an abstract portrait illustrating the artistic theory of Salvador Dali. Using Stable Diffusion, his artworks were reimagined as animated images, emphasizing the surreal and paranoiac aspects in his creations. As Dali often likened himself to a fish, his mustache was depicted as a fishbone, and various elements from his artworks were collaged to form a fish-like portrait.",
        korDescription: "살바도르 달리의 작품 세계를 담은 추상 초상화입니다. 달리의 작품을 Stable Diffusion을 활용해 움직이는 명화로 재구성하여 그의 작품에서 드러나는 초현실적이고 편집증적인 면모를 부각하였습니다. 달리가 스스로를 물고기에 자주 빗대었듯, 수염을 물고기의 뼈대로 활용하고 작품 요소들을 콜라쥬하여 한 마리의 물고기로 초상을 그려내었습니다.",
    ...
    },
    {
        ...
        year: "2023",
        link: "",
        engDescription: "This is an abstract illustration drawn on a web canvas using p5.js.",
    ...
    },
    {
        ...
        year: "2024",
        link: "",
        engDescription: "Seeya is a photo challenge SNS designed to introduce users to new spaces, people, and experiences on campus. By uploading a photo of their schedule, the platform uses computer vision to analyze the timetable and recommend nearby locations that fit their free periods. When notified, users can visit the suggested location and capture a photo resembling the provided reference image. Multi-modal AI evaluates the similarity between the two images, providing a score and feedback based on how closely they match. Through these challenges, users can discover unfamiliar corners of their school, share their experiences, and inspire others to explore and connect.",
        korDescription: "Seeya는 학교의 새로운 공간, 사람들, 경험으로 이끄는 사진 챌린지 SNS입니다. 시간표 사진을 입력하면, 컴퓨터 비전 이미지 처리를 통해 이를 인식하고 공강 시간에 맞추어 방문하기 적절한 거리의 장소를 사진을 통해 추천합니다. 알림이 오면, 사용자는 즉시 그 사진 속 공간으로 가서 제시된 사진과 유사한 사진을 찍어야합니다. 찍은 사진은 Multi-modal AI를 사용해 이미지 유사도를 측정하고, 기존 사진과 얼마나 유사한 공간 및 사진인지 점수와 평가를 도출합니다. 이러한 챌린지를 바탕으로 학교의 생소한 공간들을 방문하고, 사진과 일상을 공유하며 다른 사람들의 발걸음을 이끌 수도 있습니다.",
        mainCategory: "Website",
    ...
    },
    {
        ...
        engDescription: "Find Waffle is a puzzle-adventure game that uses optical illusions and 2D-to-3D dimensional shifts to challenge players to find a hidden waffle. Built with Three.js, the game allows players to enjoy a 3D experience directly in a web browser. I contributed to the game's planning and level design, creating 3D models of characters and an 11x11x11 grid map in a cartoon style.",
        korDescription: "Find Waffle은 착시와 2D-3D 차원 전환을 활용해 와플을 찾는 퍼즐 어드벤처 게임입니다. Three.js를 기반으로 제작되어 웹 환경에서 3D 게임을 즐길 수 있습니다. 게임 기획과 레벨 디자인에 참여하고 미국 카툰 스타일의 11x11x11 그리드 맵과 캐릭터를 3D 모델링하였습니다.",
    ...
    },
    {
        ...
        year: "2024",
        link: "",
        engDescription: "Designed promotional materials for the 2024 Spring Semester Student Work Exhibition of Seoul National University's Information Science and Culture Studies. The overall tone was inspired by motifs of moving companies and boxes, which were reflected in the designs for posters, banners, and other materials.",
        korDescription: "서울대학교 연합전공 정보문화학의2024년도 1학기 과제전의 홍보물을 작업하였습니다. 이삿짐 센터, 박스의 모티프를 바탕으로 전체적인 톤을 맞추고 포스터, 현수막 등을 디자인하였습니다.",
        mainCategory: "Poster, 594 x 841mm",
    ...
    },
    {
        ...
        engDescription: "Implemented a sliding block puzzle from the Museum of Illusion as a web game. It was designed to highlight the texture of paper through patterns and textures, and it was developed using React and Tailwind to ensure seamless graphic rendering across all screen resolutions.",
        korDescription: "Museum of Illusion에서 풀지 못한 슬라이딩 블록 퍼즐을 웹 게임으로 구현하였습니다. 패턴과 텍스쳐를 통해 종이 질감을 강조하여 디자인하였고, React와 Tailwind를 바탕으로 모든 해상도에 그래픽 붕괴 없이 대응할 수 있도록 개발하였습니다.",
        mainCategory: "Web Game",
