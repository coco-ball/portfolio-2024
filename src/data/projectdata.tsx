const projectList = [
  {
    ...
    image: [
      { id: 0, name: "mindly/thumbnail.png" },
      { id: 1, name: "mindly/1.png" },
      { id: 2, name: "mindly/2.png" },
      { id: 3, name: "mindly/3.png" },
      { id: 4, name: "mindly/4.png" },
      { id: 5, name: "mindly/5.png" },
      { id: 6, name: "mindly/6.png" },
      { id: 7, name: "mindly/7.png" },
      { id: 8, name: "mindly/8.png" },
      { id: 9, name: "mindly/9.png" },
      { id: 10, name: "mindly/10.png" },
    ],
  },
];
